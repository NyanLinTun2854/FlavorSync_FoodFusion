<footer class="bg-muted/50 border-t py-12">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="space-y-4">
                <a class="flex items-center gap-2 font-bold text-xl">
                ...
                <p class="text-muted-foreground">
                    Your culinary journey starts here. Join our community of food enthusiasts and discover the joy of
                    home
                    cooking.
                </p>
        ...
        <div class="border-t mt-12 pt-8 text-center text-muted-foreground">
            <p>
                © 2025 FoodFusion. All rights reserved. Made with ❤️ for food lovers everywhere.
            </p>
        </div>
    </div>